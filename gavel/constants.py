...
DEFAULT_EMAIL_SUBJECT = 'SoME2 Non-Video Peer Review link mix-up'

DEFAULT_EMAIL_BODY = '''
Hello {name},

<p>
We messed up when launching the Non-Video Peer Review category and accidentally labelled it the same as the Video category.
This lead to people receiving either an incorrectly labeled e-mail or 2 e-mails with essentially the same message, but a very slightly different link (one was to https://some2-nonvideo-peer-review.herokuapp.com, while the other was to https://some2-video-peer-review.herokuapp.com)

<p>
We apologize for the mix-up, but please use the following link to access the Non-Video category: <a href={link}>{link}</a>.

<p>
If you received 2 e-mails, and would like to access the Video category, please look at the links provided carefully and use the link to https://some2-video-peer-review.herokuapp.com.
