...
We are using this for the Summer of Math Exposition (SoME2) because it seems to be a well-tested and rigorous system to find winners in hack-a-thon settings.

As an important note: we fully recognize that SoME2 is not a hack-a-thon.
...
Please also use the <a href="https://docs.google.com/forms/d/e/1FAIpQLSf3rZ9Ikq72P4t04fMhV0qrwCUw3WBBuHYCi8tCLEIvPseZjA/viewform?usp=sf_link">SoME2 Specific Feedback Form</a> whenever you feel it's necessary to provide more precise feedback.
...
If there is a project that is improperly formatted or does not have an appropriate link, please e-mail 3b1b.some@gmail.com.
...
As discussed on the <a href="https://www.3blue1brown.com/blog/some1">SoME2 Website</a> please consider the following criteria when judging each entry:
...
DISCLAIMER: All of the links provided here were generated by members of the SoME2 community and have not been pre-screened for any form of profane, sexist, racist, homophobic, or other behavior that may illicit negative reactions.
If you find anything that you feel is out-of-line, please contact me at 3b1b.some@gmail.com immediately.

'''.strip()

DEFAULT_EMAIL_SUBJECT = 'Welcome to the SoME2 Peer Review!'

DEFAULT_EMAIL_BODY = '''
Hello {name}!

<p>
Thank you for agreeing to participate in the SoME2 peer review!
...
We understand that this process is subjective, so please also use the <a href="https://docs.google.com/forms/d/e/1FAIpQLSf3rZ9Ikq72P4t04fMhV0qrwCUw3WBBuHYCi8tCLEIvPseZjA/viewform?usp=sf_link">SoME2 Specific Feedback Form</a> whenever you feel it's necessary to provide more precise feedback.
